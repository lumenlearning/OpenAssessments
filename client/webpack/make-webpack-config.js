...
module.exports = function(options) {
	var entry = {
		main: path.join(__dirname, "../js/app")
	};
	var loaders = {
	...
	var outputDir = path.join(__dirname, "../../app/assets/javascripts");

	var output = {
		path: path.join(outputDir, options.prerender ? "webpack_prerender" : "webpack"),
		...
		function() {
			if(!options.prerender) {
				this.plugin("done", function(stats) {
					...
					require("fs").writeFileSync(path.join(outputDir, "stats.json"), JSON.stringify(jsonStats));
				});
			}
		},
