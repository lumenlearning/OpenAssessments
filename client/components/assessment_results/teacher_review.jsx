...
export default class TeacherReview extends BaseComponent{
  ...
  constructor(props, context){
    ...
    ReviewAssessmentActions.loadAssessmentXmlForReview(window.DEFAULT_SETTINGS, props.params.assessmentId, props.params.attemptId);
    ReviewAssessmentActions.loadAssessmentResult(props.params.assessmentId, props.params.attemptId);
