  ...
  render: function() {
    // Some function here that will get all of the users from the db and store them in an object
      var menuItems = [
        ...
        {payload: '3', text: "CLIENTS", data: "Atomic Jolt"},
        {payload: '4', text: "CLIENTS", data: "Atomic Jolt"},
        {payload: '5', text: "CLIENTS", data: "Atomic Jolt"},
        {payload: '6', text: "CLIENTS", data: "Atomic Jolt"},
