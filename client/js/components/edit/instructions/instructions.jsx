    ...
    if(false && this.props.settings.assessmentKind == "summative"){
        return (
            <ul style={{listStyleType: 'none', paddingLeft: '5px', lineHeight: '2.0', fontSize: '14px'}}>
                ...
                <li style={{padding: '2px', lineHeight: '1.25'}}> <span style={{fontWeight: 'bold'}}>Questions.</span> When a student takes a quiz, they receive 2 questions for each outcome. Accordingly, this bank must contain a minimum of 2 questions for each outcome covered.</li>
        ...
        return (
            <ul style={{listStyleType: 'none', paddingLeft: '5px', padding: '2px', fontSize: '14px'}}>
                ...
                <li style={{padding: '2px', lineHeight: '1.25'}}> <span style={{fontWeight: 'bold'}}>Questions.</span> When a student takes a SWYK, they receive 1 question for each outcome. Accordingly, this bank must contain a minimum of 1 question for each outcome that is covered.</li>
